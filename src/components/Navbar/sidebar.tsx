...
// Sample user lists with custom colors
const initialLists = [
  { id: "1", name: "Work", background_color: LIST_COLORS[1] }, // blue
  { id: "2", name: "Personal", background_color: LIST_COLORS[2] }, // green
  { id: "3", name: "Shopping", background_color: LIST_COLORS[8] }, // orange
];
      ...
      <div className="flex flex-col h-full py-4">
        ...
        <div className="flex-1 px-3 space-y-1 overflow-y-auto">
          ...
          >
            ...
            />
            {isSidebarOpen && (
              <span className="ml-3 text-sm font-medium text-left">Today</span>
            )}
          </button>
