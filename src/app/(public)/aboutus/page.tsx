...
const TeamMemberCard: React.FC<TeamMemberCardProps> = ({
  ...
  return (
    <motion.a
      ...
      className={`block rounded-xl p-6 sm:p-8 transition-all duration-300 backdrop-blur-sm border group relative overflow-hidden cursor-pointer ${
        isDark
    ...
    >
      ...
      <div className="absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
         <svg 
           ...
           viewBox="0 0 24 24"
         >
           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d=" orbit-10 14l5-5m0 0l-5-5m5 5H6" />
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    At List It, we believe that effective task & note management
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 lg:grid-cols-2 max-w-5xl mx-auto">
            ...
            <TeamMemberCard
              ...
              isDark={isDark}
              delay={0}
              portfolioUrl="https://a-moiz-portfolio.netlify.app"
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 lg:py-20 relative">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              We envision a world where task & note management is effortless and
