...
const LandingPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Footer */}
      <footer
        className={`${isDark ? "bg-gray-900 text-gray-400" : "bg-white text-gray-600"} border-t ${isDark ? "border-gray-800" : "border-gray-200"}`}
      >
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div
            className={`mt-8 border-t ${isDark ? "border-gray-800" : "border-gray-200"} pt-8 text-center`}
          >
            <p>
