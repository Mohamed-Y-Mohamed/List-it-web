            ...
            <div className="w-full flex-1 mt-8">
              ...
              <div className="mx-auto max-w-xs">
                <div className="relative">
                  ...
                  />
                  <input
                    className="w-full pl-10 pr-3 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-sky-500 focus:bg-white"
                    type="email"
                    placeholder="Email"
                  />
                </div>
